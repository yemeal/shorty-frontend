...
// Wrapper to include Header with language state (same logic as original App)
import { useState, useEffect } from 'react';
import { translations } from './App.jsx'; // reuse translations object
...
const HeaderWrapper = () => {
  ...
  return <Header lang={lang} toggleLang={toggleLang} />;
};

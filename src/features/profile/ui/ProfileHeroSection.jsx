  ...
  return (
    <div>
      <PageHeaderReveal
        ...
        titleClassName="type-display-title text-4xl sm:text-5xl text-slate-900 dark:text-white"
      ...
      <div className="mt-5 text-center">
        <p className="type-ui-title text-2xl sm:text-3xl text-slate-900 dark:text-white">
          {username || "User"}
        </p>
        ...
        <div className="mt-3">
          <Link
            to="/profile/edit"
            className="inline-flex items-center justify-center gap-2 rounded-2xl border border-white/60 dark:border-white/10 bg-white/35 dark:bg-black/20 hover:bg-white/50 dark:hover:bg-black/35 transition px-4 py-2.5 text-sm type-ui-label"
          >
            <PencilLine size={16} />
            {t.profileEdit}
          </Link>
